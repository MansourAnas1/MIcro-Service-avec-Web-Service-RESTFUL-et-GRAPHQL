Développement de microservices avec Spring Boot, implémentation d'un microservice spécialisé dans la gestion des comptes bancaires, intégrant à la fois des connecteurs GraphQL et REST.
